...
class Page_Element:
    ...
    goodscentre = ('css','#\/goods\$Menu > li:nth-child(2) > div:nth-child(1) > span:nth-child(1) > span:nth-child(2)')
    ...
    stuff_1 = ('css','body > div:nth-child(9) > div > div > div > ul > li:nth-child(1)')
    stuff_1_1 = ('css','body > div:nth-child(9) > div > div > div > ul:nth-child(2) > li:nth-child(1)')
    stuff_1_1_1 = ('css','body > div:nth-child(9) > div > div > div > ul:nth-child(3) > li:nth-child(1)')
    ...
    #商品原料下拉框
    yuanliao = ('css','ul.ant-cascader-menu:nth-child(1)')
